...
4. Zapisać i zamknąć plik exe.py
5. Otworzyć plik czas_pr.py tak samo jak exe.py w pkt.2
6. Na początku skryptu wstawić taką samą scieżkę jak w pliku exe.py (zmienna pt)
...
10. Gotowy plik excel powinnien się pojawić w lokalizacji ustawionej na koncu programu czas_pr.py
